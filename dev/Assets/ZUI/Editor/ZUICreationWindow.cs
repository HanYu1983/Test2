...
public class ZUICreationWindow : EditorWindow {
    ...
    void OnGUI()
    {
        ...
        if (GUILayout.Button("Setup", GUILayout.Height(40), GUILayout.Width(100)))
            Setup();
        GUILayout.FlexibleSpace();
        ...
        EditorGUILayout.BeginHorizontal();
        GUILayout.FlexibleSpace();
        if (GUILayout.Button("Menu", GUILayout.Height(40), GUILayout.Width(100)))
            CreateMenu();
        GUILayout.FlexibleSpace();
        EditorGUILayout.EndHorizontal();
        ...
        EditorGUILayout.BeginHorizontal();
        GUILayout.FlexibleSpace();
        if (GUILayout.Button("Pop-up", GUILayout.Height(40), GUILayout.Width(100)))
            CreatePopup();
        GUILayout.FlexibleSpace();
        EditorGUILayout.EndHorizontal();
        ...
        EditorGUILayout.BeginHorizontal();
        GUILayout.FlexibleSpace();
        if (GUILayout.Button("Side-menu", GUILayout.Height(40), GUILayout.Width(100)))
            CreateSidemenu();
        GUILayout.FlexibleSpace();
        EditorGUILayout.EndHorizontal();
        ...
        EditorGUILayout.BeginHorizontal();
        GUILayout.FlexibleSpace();
        if (GUILayout.Button("Elements Group", GUILayout.Height(40), GUILayout.Width(100)))
            CreateElementsGroup();
        GUILayout.FlexibleSpace();
        EditorGUILayout.EndHorizontal();
    ...
    Canvas CheckManagers(bool checkZUImanager)
    {
        if (checkZUImanager)
        {
            ...
            {
                if (EditorUtility.DisplayDialog("Error", "No \"ZUIManager\" found in the scene, please click on \"Setup\" to add one.", "Setup", "Cancel"))
                {
                    Setup();
                    tryCreatingAgain = true;
                }
                else
                    tryCreatingAgain = false;
                return null;
            }
        ...
        if (c == null)
        {
            if (EditorUtility.DisplayDialog("Error", "No canvas found in the scene, please make sure there's at least one.", "Create Canvas", "Cancel"))
            {
